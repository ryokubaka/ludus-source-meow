...
SCRIPT_VERSION="H35-ludus-template-align-20260808"
...
SO_TEMPLATE_MARKER="${SO_TEMPLATE_MARKER:-securityonion-2.4-packer}"
...
setup_ansible_env() {
  # Match ludus-source-bsl ansible_env_vars on packer ansible provisioner.
